...
#include "webserver/WebServer.h" //https://github.com/bbx10/WebServer_tng
#include <WiFi.h>
#else
...
#define MAXDEVICES 16 //this limit only has memory reasons, set it higher should you need to
...
String Espalexa::briForHue(int realBri)
{
  realBri--;
